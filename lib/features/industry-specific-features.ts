...
export const INDUSTRY_FEATURES: Record<string, EssentialFeatureCatalog> = {
  ...
  entertainment: {
    amenities: [
      ...
      { id: '7', key: 'rooftop_seating', name: 'Rooftop Seating', nameAr: 'جلسات سطح', icon: '🌃', importance: 'nice' },
      { id: '8', key: 'outdoor_seating', name: 'Outdoor Seating', nameAr: 'جلسات خارجية', icon: '🌳', importance: 'nice' },
    ],
    payment_methods: [
      ...
      { id: '11', key: 'mobile_payment', name: 'Mobile Payment', nameAr: 'دفع إلكتروني', icon: '📱', importance: 'important' },
    ],
    services: [
      ...
      { id: '14', key: 'bottle_service', name: 'Bottle Service', nameAr: 'خدمة زجاجات', icon: '🍾', importance: 'nice' },
      { id: '15', key: 'vip_area', name: 'VIP Area', nameAr: 'منطقة VIP', icon: '👑', importance: 'nice' },
      { id: '16', key: 'online_service', name: 'Online Booking', nameAr: 'حجز أونلاين', icon: '💻', importance: 'nice' },
    ],
    atmosphere: [
      { id: '17', key: 'live_music', name: 'Live Music', nameAr: 'موسيقى حية', icon: '🎵', importance: 'important' },
      { id: '18', key: 'dj', name: 'DJ', nameAr: 'دي جي', icon: '🎧', importance: 'important' },
      { id: '19', key: 'dancing', name: 'Dance Floor', nameAr: 'حلبة رقص', icon: '💃', importance: 'important' },
      { id: '20', key: 'dress_code', name: 'Dress Code', nameAr: 'قواعد اللباس', icon: '👔', importance: 'nice' },
    ],
  },
