...
export async function logAutoAnswer(questionId: string, result: AutoAnswerResult, userId: string) {
...
export async function logLowConfidenceAnswer(
  questionId: string,
