...
export const locationUpdateSchema = z
  .object({
    ...
    website: z
      ...
      .optional()
      .or(z.literal(null)),
    category: sanitizedString(1, 120, "Category is required")
      .optional()
      .or(z.literal(null)),
  })
  .refine((data) => Object.keys(data).length > 0, {
    message:
      "At least one field (name, address, phone, website, category) is required",
  });
...
export const questionCreateSchema = z.object({
  ...
  questionText: sanitizedString(1, 1000, "Question text is required"),
  authorName: sanitizedString(1, 100, "Author name is required").optional(),
  authorType: z.enum(["CUSTOMER", "OWNER"]).optional(),
});
