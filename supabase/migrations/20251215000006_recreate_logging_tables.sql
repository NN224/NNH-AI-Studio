-- =====================================================
-- Recreate Logging Tables - Clean Start
-- =====================================================
...
SELECT
  '✅ Logging tables recreated successfully!' as status,
  'error_logs, activity_logs, notifications are ready' as message,
  'Helper functions and views created' as additional;
