-- Fix v_dashboard_stats to calculate avg_rating from actual reviews
-- Issue: avg_rating was being calculated from gmb_locations.rating instead of gmb_reviews.rating
...
-- Add comment
COMMENT ON VIEW v_dashboard_stats IS 'Dashboard statistics view - calculates avg_rating from actual reviews, not location metadata';
