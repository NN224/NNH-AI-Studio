...
export function MediaGallery({ locationId }: MediaGalleryProps) {
  ...
  useEffect(() => {
    ...
    const handleSyncComplete = () => {
      gmbLogger.info("[MediaGallery] Sync completed, refreshing media...");
      fetchMedia();
    };
  ...
  async function fetchMedia() {
    try {
      ...
      gmbLogger.info("[MediaGallery] Fetching media", { apiUrl });
      ...
      gmbLogger.info("[MediaGallery] Received media", {
        count: result.data?.media?.length || 0,
      });
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Photos and videos from your locations
            </p>
          </div>
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2 max-w-md">
                  Photos and videos from your Google My Business locations will
                  appear here after syncing
                </p>
              </div>
            </div>
          </CardContent>
      ...
      {selectedMedia && (
        ...
        >
          ...
          >
            ...
            <div className="p-6">
              {selectedMedia.mediaFormat === "VIDEO" ||
              ...
              <div className="mt-4 space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <p className="text-sm font-medium">
                    {selectedMedia.mediaFormat || selectedMedia.type || "PHOTO"}
                  </p>
                </div>
                ...
                {getMediaUrl(selectedMedia) && (
                  <Button
                    ...
                    onClick={() =>
                      window.open(getMediaUrl(selectedMedia), "_blank")
                    }
                  >
