    ...
    <div className="achievements space-y-6">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <Card className="p-6 border-orange-500/30 bg-gradient-to-br from-orange-900/20 via-black to-purple-900/20 backdrop-blur-xl">
          ...
          {/* Filter Tabs */}
          <div className="mb-6">
            <p className="text-sm text-muted-foreground mb-3">Filter Achievements</p>
            <div className="flex items-center gap-2">
              {(['all', 'unlocked', 'locked'] as const).map((tab) => (
                <Button
                  ...
                  className={cn(filter === tab && 'bg-orange-500 hover:bg-orange-600')}
                >
                  {tab === 'all' && 'All'}
                  ...
                  {tab !== 'all' && (
                    <Badge variant="secondary" className="ml-2">
                      {
                        achievements.filter((a) => (tab === 'unlocked' ? a.unlocked : !a.unlocked))
                          .length
                      }
                    </Badge>
                  )}
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <Badge variant="outline" className={`text-${color}-500 border-${color}-500/30`}>
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div className={cn('p-3 rounded-lg', `bg-${levelColor}-500/20`)}>
                                <Icon className={cn('h-6 w-6', `text-${levelColor}-500`)} />
                              </div>
            ...
            <>
              ...
              <div className="space-y-4 mt-4">
                ...
                {selectedAchievement.progress !== undefined && selectedAchievement.maxProgress && (
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span>
                        {Math.round(selectedAchievement.progress)}/{selectedAchievement.maxProgress}
                      </span>
                    </div>
                    <Progress
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge variant="secondary">{selectedAchievement.points} points</Badge>
                    <Badge
                      variant="outline"
                      className={cn(
                        'capitalize',
                ...
                {selectedAchievement.reward && (
                  <div className="p-3 rounded-lg bg-gradient-to-br from-orange-500/10 to-yellow-500/10 border border-orange-500/20">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-sm font-medium">Special Reward</span>
                    </div>
                    <p className="text-sm text-muted-foreground">
                      {selectedAchievement.reward.type === 'badge' && 'Exclusive Badge: '}
                      {selectedAchievement.reward.type === 'feature' && 'Unlock Feature: '}
                      {selectedAchievement.reward.type === 'discount' && 'Discount: '}
