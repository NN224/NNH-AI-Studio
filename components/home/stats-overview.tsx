...
import { Building2, MessageSquare, Star, TrendingUp, Play, ArrowUp, ArrowDown } from 'lucide-react'
...
export function StatsOverview({ stats, trends }: StatsOverviewProps) {
  ...
  return (
    <div className="stats-overview grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4">
              ...
              <CardContent className="relative z-10">
                <div className="flex items-center justify-between mb-2">
                  ...
                  {stat.trend && stat.trend.length > 0 && (
                    <Sparkline
                      data={stat.trend}
                      color={stat.change && stat.change > 0 ? '#10b981' : '#ef4444'}
                    />
                  )}
                </div>
