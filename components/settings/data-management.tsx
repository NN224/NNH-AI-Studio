...
export function DataManagement({
  ...
  const setDeleteOnDisconnect =
    setDeleteOnDisconnectProp ?? setLocalDeleteOnDisconnect;
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <Label className="text-sm text-zinc-400">
                        {t("archivedData.reviews")}
                      </Label>
                      <p className="text-2xl font-bold text-zinc-100">
                        {archivedReviewsCount}
                      </p>
                      <p className="text-xs text-zinc-500 mt-1">
                        {t("archivedData.anonymized")}
                      </p>
                    </div>
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-zinc-400">
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                <li>
                  {archivedLocationsCount} {t("deleteDialog.locations")}
                </li>
                <li>
                  {archivedReviewsCount} {t("deleteDialog.reviews")}
                </li>
