...
export function CustomReportBuilder({
  ...
  const [visualization, setVisualization] =
    useState<ReportConfig["visualization"]>("table");
        ...
        <CardContent className="space-y-6">
            ...
            {scheduleEnabled && (
              <div className="space-y-2 pl-4">
                ...
                <Select
                  ...
                  onValueChange={(v) => setScheduleFrequency(v as any)}
                >
          ...
          <div className="flex flex-wrap gap-2">
            <Button
              ...
              disabled={
                isBuilding || !reportName.trim() || selectedMetrics.length === 0
              }
              className="gap-2"
            >
