              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div
                      className={`flex items-center text-xs font-medium ${trendColor} cursor-help`}
                    >
...
export const StatsCards = memo(function StatsCards({
  ...
  // ✅ FIX: Use safe number formatting to prevent NaN
    ...
    () => [
      {
        ...
        value: safeNumber(stats.totalLocations),
        trend: safeNumber(stats.locationsTrend),
      ...
      },
      {
        ...
        value: safeNumber(stats.averageRating).toFixed(1),
        trend: safeNumber(stats.ratingTrend),
      ...
      {
        title: "Total Reviews",
        value: safeNumber(stats.totalReviews).toLocaleString(),
        trend: safeNumber(stats.reviewsTrend),
      ...
      {
        title: "Response Rate",
        value: `${safeNumber(stats.responseRate).toFixed(1)}%`,
        icon: <Target className="h-4 w-4" />,
        target: safeNumber(stats.responseTarget, 100),
        loading,
      },
    ],
