...
export default function OwnerDiagnosticsPage() {
  ...
  const diagnosticTabs = [
    ...
    },
    {
      ...
      description: 'Test all GMB API endpoints (Accounts, Locations, Reviews, Questions, Posts, Media, Insights)',
    ...
    // 🔄 Sync & Data Tests
    {
      ...
      description: 'Verify how recent your synced data is and detect stale locations',
    ...
    // 🤖 AI Tests
    {
      ...
      description: 'Test AI providers (Anthropic, OpenAI, Google, Groq) and features (Auto-Reply, Auto-Answer)',
  ...
  return (
    <div className="container mx-auto pt-8 pb-8 space-y-6">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">🔬 Production Readiness Diagnostics</h1>
        <p className="text-muted-foreground">
          Comprehensive system health checks for Google My Business integration
        </p>
        <div className="flex gap-2 text-sm">
          <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded">🔐 GMB & OAuth (2)</span>
          <span className="px-2 py-1 bg-green-100 text-green-800 rounded">🔄 Sync & Data (4)</span>
          <span className="px-2 py-1 bg-purple-100 text-purple-800 rounded">🤖 AI (1)</span>
          <span className="px-2 py-1 bg-orange-100 text-orange-800 rounded">💾 Database (3)</span>
          <span className="px-2 py-1 bg-gray-100 text-gray-800 rounded">🔧 System (2)</span>
        </div>
      </div>
