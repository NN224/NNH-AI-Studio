...
export async function POST(
  ...
  try {
    ...
    if (!question.external_question_id) {
      ...
      console.warn(
        "[Q&A API] Question missing external_question_id, saving locally only",
      );
    }
    ...
    if (!isDraft && question.external_question_id && location.location_id) {
      try {
        ...
        console.error(
          "[Q&A API] Failed to publish answer to Google:",
          googleError,
        );
  ...
  try {
    ...
    if (
      ...
      try {
        ...
        console.error(
          "[Q&A API] Failed to delete answer from Google:",
          googleError,
        );
