  ...
  return (
    <Card className="bg-zinc-900/50 border-orange-500/20">
      <CardHeader>
        ...
        <CardDescription>
          Manage customer questions for {location.location_name}
        </CardDescription>
      </CardHeader>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-zinc-400">
                Quick responses to customer questions improve your business
                credibility. Answered questions appear on your Google Business
                Profile.
              </p>
            </div>
          </div>
