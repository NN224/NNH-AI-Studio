  ...
  return (
    <Card className="bg-zinc-900/50 border-orange-500/20">
      <CardHeader>
        ...
        <CardDescription>
          Create and manage Google posts for {location.location_name}
        </CardDescription>
      </CardHeader>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-zinc-400">
                Regular posts keep your business fresh in Google Search and
                Maps. Posts with offers or events get 2x more engagement.
              </p>
            </div>
          </div>
        </div>
